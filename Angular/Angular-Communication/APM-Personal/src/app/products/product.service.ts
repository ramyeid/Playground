...
export class ProductService {
    ...
    // if you use Subject 
    // => if you go from one page to another you will not ahve the state maintained
    //         and that means the selection will not be maintained
    // but if you use BehaviorSubject
    //  => you have the possibility to have an initial value
    //  => and also on new subscription we sent last emitted value to the new subscribers 
